...
Gitea is a good self-hosted git registry option. Gitea is very lightweight, often taking using under 1GB ram. Other options like Gitlab Community Edution often use over 5GB ram.
