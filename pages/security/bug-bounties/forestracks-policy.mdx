...
- Avoid disclosing the vulnerability publicly before it has been resolved.
...
To report a vulnerability, please send an email to [security@forestracks.com](mailto:security@forestracks.com) with the subject line "Bug Bounty Submission." Include the following information in your report:
