# ForestRacks Bug Bounty Program Guide

This document constitutes the Bug Bounty Program for Forest Racks LLC d/b/a ForestRacks (hereinafter "ForestRacks," "we," "us," or "our")
...
- Discover a previously unknown vulnerability in software ForestRacks created.
...
- **Customer Data**: You must not access, attempt to access, or disclose any customer data during your testing. This includes personal information, payment data, and any other sensitive customer information.
- **Third-Party Vulnerabilities**: Vulnerabilities in third-parties are out of scope. This includes externally maintained software, libraries, and frameworks.
- **Denial of Service (DoS) Attacks**: Any form of DoS attacks or resource exhaustion attacks.
- **Social Engineering**: Activities that involve social engineering or phishing.
- **Physical Attacks**: Physical security or hardware vulnerabilities.
...
To report a vulnerability, please send an email to [security@forestracks.com](mailto:security+bugbounty@forestracks.com) with the subject line "Bug Bounty Submission." Include the following information in your report:
...
## Legal
Participation in our bug bounty program is subject to the following terms:
