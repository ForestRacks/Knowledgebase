...
- **Third-Party Vulnerabilities**: Vulnerabilities in third-parties are out of scope, whether or whether not we use them. This includes externally maintained software, libraries, and frameworks.
