...
For specifics on how [MySQL users](/mysql/creating-users) work and how [MySQL privileges](/mysql/creating-databases) work, follow the corresponding guides but this example, is using the MySQL shell to allow access to the remote IP `192.168.53.72`.
```sql
