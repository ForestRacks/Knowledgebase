...
```
## Post Installation:
Please note "YOUR_FQDN" refers to the panel URL you set during the installation process.
* After the installation is complete, go to http://YOUR_FQDN/admin/nodes/view/1/allocation to add the necessary ports for your games.
