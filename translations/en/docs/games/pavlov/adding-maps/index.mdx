---
title: Adding Maps to Pavlov VR Servers
description: Learn how to add maps to your Pavlov VR server.
---

## Configuration

The process of adding maps to your Pavlov server varies whether you use Shack or PC. Before adding a map, you should first select a [Game Mode](/docs/games/pavlov/adding-maps#available-game-modes) and then follow the steps below.
