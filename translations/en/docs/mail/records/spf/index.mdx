---
title: SPF Records: Authorize Mail Servers for Your Domain
toc: SPF Records
description: Create SPF DNS records to prevent email spoofing and improve deliverability. Covers syntax, mechanisms (A, MX, IP4, include), and validation testing.
---
