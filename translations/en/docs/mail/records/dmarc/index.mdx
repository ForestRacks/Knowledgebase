---
title: Understanding DMARC for Email Spoofing Protection
toc: DMARC Protection
description: Set up DMARC policies to prevent phishing and email fraud. Learn DNS syntax, policy enforcement options (none, quarantine, reject), and aggregate reporting.
---
