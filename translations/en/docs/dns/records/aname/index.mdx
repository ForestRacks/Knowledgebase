---
title: "DNS ANAME Records: Alias Records at the Zone Apex"
description: Use ANAME records to point apex domains to other hostnames. Alternative to CNAME at root with CNAME flattening support from Cloudflare and GCore.
---
