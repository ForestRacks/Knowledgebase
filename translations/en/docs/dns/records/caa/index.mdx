---
title: "DNS CAA Records: Restrict SSL Certificate Authorities"
description: Use CAA records to authorize specific certificate authorities for your domain. Prevent unauthorized SSL/TLS certificate issuance.
---
