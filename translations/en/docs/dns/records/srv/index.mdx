---
title: "DNS SRV Records: Service Location and Discovery"
description: Configure SRV records for Minecraft and game servers to use custom ports with domain names. Includes priority, weight, and port setup guide.
---
