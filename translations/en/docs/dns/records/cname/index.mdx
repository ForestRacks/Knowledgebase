---
title: "DNS CNAME Records: How Domain Aliases Work"
description: How CNAME records create domain aliases and redirects. Explains CNAME flattening for root domains with Cloudflare and other DNS providers.
---
...
1. **[Cloudflare](/docs/dns/providers/resolvers/cloudflare):**
...
2. **Other Providers:**
- Many modern DNS providers include CNAME flattening by default for the zone apex.
