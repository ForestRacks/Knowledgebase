---
title: "DNS NS Records: How Nameservers Work"
description: Configure NS records to delegate domain authority to name servers. Covers DNS hierarchy, redundancy, load balancing, and domain delegation.
---
