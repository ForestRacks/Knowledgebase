---
title: "Top-Level Domains (TLDs): Types and How They Work"
description: "Learn what a Top-Level Domain (TLD) is, its purpose, and how it functions within the domain naming hierarchy."
---
...
- **.org**: Non-profit organizations (However, anyone can register)
- **.net**: Network-related entities
- **.gov**: U.S. government agencies (Verified U.S. government entities)
- **.edu**: Educational institutions (Verified educational institutions only)
