---
title: Wildcard SSL Certificates with Certbot and Cloudflare
toc: "Wildcard Certificates"
description: Generate wildcard SSL certificates using Certbot DNS challenge with Cloudflare API. Covers DNS token setup, dependencies, and automatic renewal.
---
