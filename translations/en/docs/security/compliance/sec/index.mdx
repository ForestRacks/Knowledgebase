---
title: SEC Cybersecurity Compliance Checklist and Guidelines
description: Complete SEC cybersecurity compliance requirements including risk assessments, security policies, encryption standards, and audit documentation for firms.
---

The SEC does not publicly provide any checklist that has to be completed to pass an audit. The best current guidance at the time of writing this guide seems to be found [here](https://web.archive.org/web/20150208213451/http://www.sec.gov/ocie/announcement/Cybersecurity+Risk+Alert++%2526+Appendix+-+4.15.14.pdf).

Pulled from that document are the following areas of interest:
<Stepper>
<StepperItem title="Keep Records">
...
<StepperItem title="Give SEC Security Policy">
...
<StepperItem title="Indicate Periodic Assessments">
...
<StepperItem title="Insurance Policy">
...
<StepperItem title="Compliance Standards">
* Identify any cybersecurity risk management standards that the Firm follows such as those issued by [National Institute Standards and Technology (NIST)](/docs/security/compliance/nist-compliance) or the [International Organization for Standards (ISO)](/docs/security/compliance/iso-compliance).
...
<StepperItem title="Protection Practices">
...
<StepperItem title="Compliance Audits">
* Does the Firm conduct frequent security policy audits?
* What year was the most recent audit and who conducted the audit?

</StepperItem>
<StepperItem title="Online Account Access">
* Does the Firm provide customers with online account access?
* Name any third-parties that manage the service
* Functionality for your customers on the platform (e.g. balance inquiries, address and contact information changes, beneficiary changes, transfers among the customer's accounts, withdrawals or other external transfers of funds)
...
<StepperItem title="Addressing Attack Losses">
...
<StepperItem title="Vendors and Business Partners">
#### Third-Party Risks
* Does Firm require cybersecurity risk assessments of vendors and business partners's access to the Firm's network, customer data, or other sensitive information?
...
<StepperItem title="Job Responsibilities">

* Provide a copy of the Firm's written job descriptions for employees with cybersecurity responsibilities.

</StepperItem>
<StepperItem title="Identify Theft Red Flag Rules">

#### Identify Theft Red Flag Rules
* Does the Firm have a written identity theft prevention program?
* Provide a copy of the program and the date it was last updated.
* Describe the Firm's procedures for identifying, detecting, and responding to red flags that may indicate identity theft.

</StepperItem>
<StepperItem title="How Firm Prioritizes Practices">
* Describe how the Firm prioritizes cybersecurity practices based on the sensitivity of customer information and the potential impact of a cybersecurity incident.

</StepperItem>
<StepperItem title="Crime Reporting">

#### Identified Threats
* Describe the Firm's procedures for reporting cybersecurity incidents to law enforcement, regulators, and other relevant parties.

#### Theft or Loss
* Describe the Firm's procedures for reporting theft or loss of customer information, including the process for notifying affected customers.

#### Reporting
* Provide a copy of the Firm's procedures for reporting cybersecurity incidents to the SEC, including the process for notifying affected customers and other relevant parties.

</StepperItem>
<StepperItem title="Serious Cybersecurity Risk">
* Describe the Firm's procedures for identifying and addressing serious cybersecurity risks, including the process for notifying affected customers and other relevant parties.

</StepperItem>
<StepperItem title="Provide Other Info">
* Provide any other information that the Firm believes is relevant to its cybersecurity practices and procedures.
</StepperItem>
</Stepper>
