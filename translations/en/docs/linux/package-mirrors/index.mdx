---
title: Configure Fast APT Package Mirrors
toc: Fast Package Mirrors
description: Switch Ubuntu, Debian, and CentOS to ForestRacks mirrors for faster package downloads. Automatic sources.list replacement script included.
---
