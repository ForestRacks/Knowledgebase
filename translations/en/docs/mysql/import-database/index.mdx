---
title: How To Import MySQL Databases from SQL Files
toc: Import MySQL Database
description: Import .sql dump files into MySQL databases using the mysql command line or source command. Quick methods for restoring database backups on Linux servers.
---
