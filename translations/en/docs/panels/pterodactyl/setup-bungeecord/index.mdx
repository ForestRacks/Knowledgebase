---
title: Set Up BungeeCord Network on Pterodactyl with Docker
toc: Setup BungeeCord
description: Create a secure BungeeCord Minecraft proxy network on Pterodactyl. Configure subservers, firewall rules, and Docker networking for multi-server setups.
---
...
<Stepper>
<StepperItem title="Creating a BungeeCord Server">
...
<StepperItem title="Configuring BungeeCord">
...
<StepperItem title="Firewall Configuration">
...
<StepperItem title="Pterodactyl Subservers Configuration">
