...
toc: Install Pterodactyl
description: Deploy Pterodactyl Panel quickly using our automated bash installer. Supports basic and advanced modes with Let's Encrypt SSL and troubleshooting tips.
---
...
## Installation:
<Stepper>
<StepperItem title="Clean Linux Installation">
