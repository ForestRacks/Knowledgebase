---
title: How To Install Blesta Billing Panel
description: Step-by-step Blesta installation tutorial with Apache, PHP 8.1, IonCube, MariaDB, and Let's Encrypt SSL configuration for billing automation.
---

<Stepper>
<StepperItem title="Download Blesta">
...
```apacheconf:blesta.conf showLineNumbers {2,23,36,37}
<VirtualHost *:80>
...
<StepperItem title="Create Blesta Cronjob">
```bash
