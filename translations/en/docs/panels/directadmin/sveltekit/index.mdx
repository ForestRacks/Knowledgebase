---
title: Deploy SvelteKit Apps on DirectAdmin with Node.js Server
toc: Deploy SvelteKit Apps
description: Build and deploy SvelteKit applications on DirectAdmin using the node-adapter. Configure Node.js server settings and verify your production deployment.
---
