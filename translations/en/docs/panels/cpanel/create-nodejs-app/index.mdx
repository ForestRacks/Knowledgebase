---
title: Deploy Node.js Apps in cPanel Using Node.js Selector
toc: Deploy Node.js Apps
description: Create and configure Node.js applications in cPanel with the Node.js Selector. Upload files, install npm packages, and deploy in minutes.
---

<Stepper>
<StepperItem title="Create the application on the cPanel Selector">
...
<StepperItem title="Upload the Node.js application">
...
<StepperItem title="Install the Node.js packages">
