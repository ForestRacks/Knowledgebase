---
title: Rate Limit SMTP Mail Ports with iptables on Linux
toc: Rate Limit Mail Ports
description: Prevent email abuse and spam by rate limiting outgoing mail ports 25, 465, 587, and 995 using iptables. Includes persistent rules setup for Ubuntu and Debian.
---
