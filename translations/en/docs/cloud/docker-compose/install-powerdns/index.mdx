---
title: Deploy PowerDNS with Docker Compose - DNS Server Setup
toc: "Install PowerDNS"
description: Set up authoritative DNS server using PowerDNS and Docker Compose. Includes MariaDB backend, web admin interface, and API configuration.
---
