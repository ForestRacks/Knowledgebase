---
title: Deploy Gitea with Docker Compose - Self-Hosted Git Server
description: Set up a lightweight self-hosted Git server using Gitea and Docker Compose. Includes PostgreSQL database, CI/CD runner configuration, and persistent storage.
---
