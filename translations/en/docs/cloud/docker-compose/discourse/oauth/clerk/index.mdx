---
title: Configure Clerk OAuth for Discourse - SSO Integration
description: Integrate Clerk authentication with Discourse forum. Complete setup guide for OAuth2 plugin, API key generation, and user profile mapping.
---
