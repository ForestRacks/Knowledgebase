---
title: Install MicroK8s on Ubuntu - Lightweight Kubernetes Setup
toc: "Install MicroK8s"
description: Deploy lightweight Kubernetes using MicroK8s on Ubuntu. Includes snap installation, firewall configuration, and essential addons like DNS and storage.
---
