---
title: How To Install Fiber Go Web Framework
toc: Install Fiber
description: Build fast Go web applications with Fiber framework. Learn to install Go, initialize a project, create routes, and run your first Fiber HTTP server.
---

<Stepper>
<StepperItem title="Install Go">
Get the latest version of Go from [the official Golang website](https://golang.org/dl/) and follow the instructions.

</StepperItem>
<StepperItem title="Create Go Project">
...
<StepperItem title="Explore Fiber">
