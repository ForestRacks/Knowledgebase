---
title: Understanding robots.txt for Search Engine Crawlers
toc: robots.txt Guide
description: Create and configure robots.txt to manage search engine crawling. Learn User-agent, Disallow, Allow directives, plus Cloudflare-specific recommendations.
---
...
<StepperItem title="Create robots.txt file">
Start a new file and save it as "robots.txt".
</StepperItem>
<StepperItem title="Copy default robots.txt">
