---
title: How To Set Up security.txt for Vulnerability Disclosure
toc: security.txt Setup
description: Create a security.txt file for responsible vulnerability disclosure. Configure Contact, Encryption, Policy, and Acknowledgments fields per RFC 9116.
---
...
<Stepper>
<StepperItem title="Open a Text Editor">
Open a text editor or any preferred text editing software.
</StepperItem>
<StepperItem title="Create security.txt file">
Start a new file and save it as "security.txt".
</StepperItem>
<StepperItem title="Copy default security.txt">
Begin by adding the following lines to define security policies:
```bash:security.txt
